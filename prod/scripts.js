...
$(document).ready(function () {
  ...
  $('.navbar > button.toggle-nav-btn').first().on('click', function () {
    ...
    var navContainer = $('.navbar > .nav-container');
...
function displayIntro() {
  ...
  var parts = ["&nbsp;" + lineNumber(1) + '&nbsp;'.repeat(2) + comment('// TODO: display about me') + "<br>", "&nbsp;" + lineNumber(2) + '&nbsp;'.repeat(2) + kw1('var') + " " + kw2('me') + " = {<br>", "&nbsp;" + lineNumber(3) + '&nbsp;'.repeat(6) + kw2('name:') + " " + kw3('\"Oleksandr Hryk\"') + ",<br>", "&nbsp;" + lineNumber(4) + '&nbsp;'.repeat(6) + kw2('years:') + " " + kw4('24') + ",<br>", "&nbsp;" + lineNumber(5) + '&nbsp;'.repeat(6) + kw2('phone:') + " " + kw3('\"+38 (098) 606-09-89\"') + ",<br>", "&nbsp;" + lineNumber(6) + '&nbsp;'.repeat(6) + kw2('email:') + " " + kw3('\"ahryk94@gmail.com\"') + ",<br>", "&nbsp;" + lineNumber(7) + '&nbsp;'.repeat(6) + kw2('skype:') + " " + kw3('\"alexander.hryk\"') + ",<br>", "&nbsp;" + lineNumber(8) + '&nbsp;'.repeat(6) + kw2('skills:') + " [" + kw3('\"JS\"') + ", " + kw3('\"Node.js\"') + ",<br>", "&nbsp;" + lineNumber(9) + '&nbsp;'.repeat(15) + kw3('\"jQuery\"') + ", " + kw3('\"Angular\"') + "]<br>", "" + lineNumber(10) + '&nbsp;'.repeat(2) + "};<br>", lineNumber(11) + "<br>", "" + lineNumber(12) + '&nbsp;'.repeat(2) + kw4('$') + "(" + kw3('\"#aboutme\"') + ")." + kw4('html') + "(" + kw4('wrap') + "(" + kw2('me') + "));"];
  var intro1 = new Typed('#intro1', {
    strings: [parts.join('')],
    typeSpeed: 50
  });
  var intro2 = new Typed('#intro2', {
    strings: [parts.join('')],
    typeSpeed: 50
  });
}
